...
const RECOMMENDED_PLAN_GENERATION_ALIASES = ['opus55', 'fable51', 'opus5', 'sonnet5', 'astra', 'flash38-high', 'mistral'];
...
const RECOMMENDED_PR_REVIEW_ALIASES = ['opus55', 'fable51', 'opus5', 'sonnet5', 'astra', 'flash38-high', 'mistral'];
